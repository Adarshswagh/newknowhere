...
<section id="banner-main">
    <div class="banner">
        ...
        <div class="banner-content">
            <h2>Commercial Projects List</h2>
            <p class="banner-bread">
                <a href="index.php">Home</a> &gt; 
                <a href="#">Commercial Projects List</a>
            </p>
        </div>
    </div>
</section>
    ...
    <div class="pune-container">
        ...
        <div class="pune-left-section">
            <div class="pune-row">
                ...
                <?php 
                    $commercial_query = mysqli_query($con, "SELECT * FROM `commercial_projects` WHERE city='Pune'");
                        ...
                        <div class="pune-property-card">
                            ...
                            <div class="pune-property-info">
                                ...
                                <div class="pune-button-container">
                                    ...
                                    <a href="https://wa.me/9112211291" target="_blank" class="btn-icon whatsapp-btn" title="WhatsApp">
    <i class="fab fa-whatsapp"></i>
</a>
<a href="tel:+9112211291" class="btn-icon call-btn" title="Call">
