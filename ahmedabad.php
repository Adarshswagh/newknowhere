...
<section id="banner-main">
    <div class="banner">
        <img src="images/banner/ahmedabad.jpg" alt="Banner" class="banner-img">
    ...
    <div class="pune-container">
        ...
        <div class="pune-left-section">
            <div class="pune-row">
                ...
                <?php 
                    $residential_query = mysqli_query($con, "SELECT * FROM `residential_projects` WHERE city='Ahmedabad'");
                ...
                <?php 
                    $commercial_query = mysqli_query($con, "SELECT * FROM `commercial_projects` WHERE city='Ahmedabad'");
                ...
                <!-- Plotting Properties -->
                <?php 
                    $plotting_query = mysqli_query($con, "SELECT * FROM `plotting_projects` WHERE city='Ahmedabad'");
