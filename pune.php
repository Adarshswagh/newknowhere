    ...
    <div class="pune-container">
        ...
        <div class="pune-left-section">
            <div class="pune-row">
                ...
                <?php 
                    $residential_query = mysqli_query($con, "SELECT * FROM `residential_projects` WHERE city='Pune'");
                ...
                <!-- Plotting Properties -->
                <?php 
                    $plotting_query = mysqli_query($con, "SELECT * FROM `plotting_projects` WHERE city='Pune'");
