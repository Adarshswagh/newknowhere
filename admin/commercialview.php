                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
											...
											<?php 
												...
												$residential_query = mysqli_query($con, "SELECT * FROM `commercial_projects`");
											...
											?>
                                                ...
                                                <tr>
													...
													<td><a href="commercialprojectedit.php?pid=<?php echo $row['0'];?>"><button class="btn btn-info">Edit</button></a>
