...
if (isset($_POST['add'])) {
    ...
    if (!$error) {
        ...
        $sql = "UPDATE commercial_projects SET 
        ...
        if ($result) {
            ...
            header("Location: commercialview.php?msg=$msg");
            exit;
        } else {
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<?php
                                $pid = $_REQUEST['pid'];
                                $query = mysqli_query($con, "SELECT * FROM commercial_projects WHERE pid='$pid'");
										...
										<div class="row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control"       name="typology">
                                                            ...
                                                            <option value="Shop" <?= $row['typology'] == 'Shop' ? 'selected' : ''; ?>>Shop</option>
                                                            <option value="Office" <?= $row['typology'] == 'Office' ? 'selected' : ''; ?>>Office</option>
                                                            <option value="Restaurant" <?= $row['typology'] == 'Restaurant' ? 'selected' : ''; ?>>Restaurant</option>
                                                            <option value="Studio" <?= $row['typology'] == 'Studio' ? 'selected' : ''; ?>>Studio</option>
                                                            <option value="Showroom" <?= $row['typology'] == 'Showroom' ? 'selected' : ''; ?>>Showroom</option>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="possession"      placeholder="Enter Possession" value="<?php echo $row['possession']; ?>">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Scheme</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="scheme"      placeholder=" Enter Scheme" value="<?php echo $row['scheme']; ?>">
													</div>
												</div>
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="project_area"      placeholder="Enter Project Area" value="<?php echo $row['project_area']; ?>">
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="size"      placeholder="Enter Typology Size" value="<?php echo $row['size']; ?>">
													</div>
												</div>
