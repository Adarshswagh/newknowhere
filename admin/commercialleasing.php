...
$sql = "INSERT INTO commercialleasing_projects (project_title, project_description, project_location, project_area, typology, maintainance, size, price, oldproject, image1,image2,image3,image4,image5,featured, city, developer)
		VALUES ('$project_title', '$project_description', '$project_location', '$project_area', '$typology', '$maintainance', '$size', '$price', '$oldproject','$image1','$image2','$image3','$image4','$image5','$featured', '$city', '$developer')";

$result = mysqli_query($con, $sql);
if ($result) {
	$msg = "<p class='alert alert-success'>Commercial Leasing Project Inserted Successfully</p>";
} else {
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Commercial Leasing Project</h3>
								<ul class="breadcrumb">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Add Commercial Leasing Project Details</h4>
								</div>
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label"> Developer</label>
													<div class="col-lg-9">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="maintainance"      placeholder="Enter Maintenance">
													</div>
												</div>

												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Project Old</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="oldproject"      placeholder="Enter Project Old">
													</div>
												</div>
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="price"      placeholder="Enter Rent">
													</div>
												</div>
