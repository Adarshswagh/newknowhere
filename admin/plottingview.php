                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
											...
											<?php 
												...
												$residential_query = mysqli_query($con, "SELECT * FROM `plotting_projects`");
											...
											?>
                                                ...
                                                <tr>
													...
													<td><a href="plottingprojectedit.php?pid=<?php echo $row['0'];?>"><button class="btn btn-info">Edit</button></a>
