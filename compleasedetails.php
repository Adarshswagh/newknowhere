...
$similar_query = mysqli_query($con, "SELECT * FROM commercialleasing_projects WHERE project_location='$location' AND pid != '$id' LIMIT 5"); // Adjust the query as needed
  ...
  document.addEventListener("DOMContentLoaded", showSlides); // Start when page loads
            ...
            <div class="property-details">
                <div class="detail-item">
                    ...
                    <p class="project-detail"><?php echo htmlspecialchars($row['3']); ?>, <?php echo htmlspecialchars($row['16']); ?></p>
                </div>
            ...
            <div class="property-details-section">
                <div class="properties-details">
                    ...
                    <div class="detail-grid">
                        <div><strong class="field-title">Project Developer :</strong> <span style="color:#A8894D; font-ize:20px;"><?php echo htmlspecialchars($row['17']); ?></span></div>
                        <div><strong class="field-title">Typology PSF :</strong> <span style="color:#A8894D; font-size:20px;"><?php echo htmlspecialchars($row['18']); ?></span></div>
            ...
            <div class="custom-card">
              ...
              <div class="info-section">
                ...
                <div class="cta-buttons">
                  <a href="compleasedetails.php?pid=<?php echo $project['0']; ?>" class="main-btn">KNOW MORE</a>
