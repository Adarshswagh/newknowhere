    ...
    <div class="pune-container">
        ...
        <div class="pune-left-section">
            <div class="pune-row">
                ...
                <?php 
                    $commercial_query = mysqli_query($con, "SELECT * FROM `commercialleasing_projects` WHERE city='Pune'");
                    while ($row = mysqli_fetch_array($commercial_query)) {
                ?>
                <div class="pune-col-md-6 pune-col-sm-10">
                    <a href="compleasedetails.php?pid=<?php echo $row['0']; ?>" class="pune-property-card-link">
                        <div class="pune-property-card">
                            ...
                            <div class="pune-property-info">
                                ...
                                <div class="pune-button-container">
                                        <a href="compleasedetails.php?pid=<?php echo $row['0']; ?>" class="pune-view-more-btn">Know More</a>
                                        <a href="https://wa.me/9112211291" target="_blank" class="btn-icon whatsapp-btn">
                                                <i class="fab fa-whatsapp"></i>
                                            </a>
                                            <a href="tel:+91122 11291" class="btn-icon call-btn">
