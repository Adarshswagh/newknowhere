...
$similar_query = mysqli_query($con, "SELECT * FROM plotting_projects WHERE project_location='$location' AND pid != '$id' LIMIT 5"); // Adjust the query as needed
          ...
          <div class="auto-slide">
            <div class="custom-card">
              <div class="image-section">
                <img src="admin/property/<?php echo $project['0']; ?>" alt="Project Image" />
                <div class="custom-badge">Plotting Projects</div>
              </div>
