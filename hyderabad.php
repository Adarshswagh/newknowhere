...
<section id="banner-main">
    <div class="banner">
        <img src="images/banner/hydrebad.jpg" alt="Banner" class="banner-img">
        <!-- <div class="banner-content">
            <h2>Hyderabad Projects List</h2>
            <p class="banner-bread">
                <a href="index.php">Home</a> &gt; 
                <a href="#">Hyderabad Projects List</a>
            </p>
        </div> -->
    </div>
</section>
    ...
    <div class="pune-container">
        ...
        <div class="pune-left-section">
            <div class="pune-row">
                ...
                <?php 
                    $residential_query = mysqli_query($con, "SELECT * FROM `residential_projects` WHERE city='Hyderabad'");
                ...
                <?php 
                    $commercial_query = mysqli_query($con, "SELECT * FROM `commercial_projects` WHERE city='Hyderabad'");
                ...
                <!-- Plotting Properties -->
                <?php 
                    $plotting_query = mysqli_query($con, "SELECT * FROM `plotting_projects` WHERE city='Hyderabad'");
